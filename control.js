...
$(() => {
	...
	$("#video_selector").change(function (e) {
		let str = "https://clips.twitch.tv/ColdbloodedBlatantCucumberHeyGuys-wOnCFj8hZzA44fzG";
...
function download_clip(e){
	let str2 = "https://clips-media-assets2.twitch.tv/5lEHRsDpwhY_IWcwOOH8xg/41812559995-offset-37664.mp4";
	httpGetAsync(e.value, (result) =>{
		console.log(result)
	});
};
